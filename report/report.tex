...
order to improve its integration in Sherlok. In the Appendix <?> we show a few other alternatives
that were considered during this project but not good enough for our needs.

\subsection{Initial Situation}

\TODO{re-explain the issue of global variable with an concrete example}

\TODO{bluima not available in Maven central}

\TODO{central point of project -> make it easier to integrate any engine in Sherlok}

\subsection{Proposed Solution}

\TODO{several significant constraint identified: refactoring, resource interdependency, batch of
files, flexibility for the user}

\TODO{conclusion: adopted solution}

\TODO{cmp table}

\TODO{see annex for more details on Maven-based strategy}
